    ...
    def _generate_markdown_report(
        ...
        if self.config.include_summary:
            ...
            if trend_report.hot_topics:
                ...
                lines.append(f"今日热点集中在: **{', '.join(top_topics)}** 等领域。")
        ...
        if trend_report.emerging_trends:
            ...
            for trend in trend_report.emerging_trends[:5]:
                lines.append(f"- **{trend.name}**: {trend.summary or f'热度 {trend.heat_score:.0f}'}")
            lines.append("")
        ...
        if trend_report.industry_dynamics:
            for dynamic in trend_report.industry_dynamics:
                sentiment_emoji = {"positive": "📈", "negative": "📉", "neutral": "➡️"}.get(dynamic.sentiment, "➡️")
...
if __name__ == "__main__":
    ...
    test_trend = TrendReport(
        ...
        hot_topics=[
            ...
            TrendItem(name="量子计算", category="research", heat_score=80, mention_count=10),
            TrendItem(name="云原生", category="cloud_infra", heat_score=70, mention_count=8),
        ],
    ...
    test_articles = [
        {"title": "OpenAI发布GPT-5", "source": "TechCrunch", "category": "ai_ml", "importance": 5},
        {"title": "谷歌云新功能发布", "source": "The Verge", "category": "cloud_infra", "importance": 4},
        {"title": "安全漏洞警报", "source": "Wired", "category": "security", "importance": 4},
    ]
